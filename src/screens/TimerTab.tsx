  ...
  return (
    <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
      ...
      <View style={{ alignItems: 'center', marginVertical: 32 }}>
        <TimerRing formattedTime={format(seconds)} />
      </View>
      ...
      <View style={[styles.row, { justifyContent: 'center', gap: 24, marginBottom: 20 }]}>
        ...
        <TouchableOpacity style={styles.playCircle} onPress={handleToggle}>
          <Ionicons name={isRunning ? "pause" : "play"} size={28} color="#FFF" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.iconCircle} onPress={handleComplete}>
      ...
      <View style={styles.card}>
        ...
        {timerCourse && tasks.filter((t) => !t.completed && t.courseId === timerCourse).length > 0 && (
          <View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 6, paddingVertical: 4 }}>
              <TouchableOpacity style={[styles.chip, timerTask === '' && styles.chipActive]} onPress={() => setTimerTask('')}><Text style={styles.chipText}>Nessuno / Solo Corso</Text></TouchableOpacity>
      ...
      <Modal visible={celeb} transparent animationType="fade">
        <View style={styles.overlay}>
          <View style={styles.modal}>
            ...
            <Text style={[styles.cardDesc, { textAlign: 'center', marginBottom: 16 }]}>Hai completato con successo un ciclo di studio di 25 minuti!</Text>
            ...
            <TouchableOpacity style={[styles.saveBtn, { width: '100%', marginTop: 16 }]} onPress={() => setCeleb(false)}>
...
const styles = StyleSheet.create({
  ...
  playCircle: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#8B5CF6', alignItems: 'center', justifyContent: 'center' },
