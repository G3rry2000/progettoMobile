...
const styles = StyleSheet.create({
  ...
  chart: { flexDirection: 'row', alignItems: 'flex-end', height: 120, paddingTop: 12, paddingHorizontal: 10 },
  chartCol: { alignItems: 'center', width: 60, marginHorizontal: 6 },
  ...
  chartLbl: { fontSize: 10, color: '#64748B', marginTop: 8, width: 60, textAlign: 'center', paddingHorizontal: 4 },
});